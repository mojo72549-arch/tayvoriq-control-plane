...
Also preserve source_context.story_first_script_body (38-49 German words, at least
three natural sentences), source_context.editorial_story_contract_version=2,
research_notes and factual_guardrails. Compose the story only from dossier evidence;
never substitute concatenated fallback answers. Apply the full editorial contract:
{prompt}
DOSSIER:
{dossier[:28000]}
""".strip()
