...
def patch_player() -> None:
    ...
    replace_once(
        ...
        "    }\n\n"
        "    private void applyPictureInPictureUi(boolean active) {\n"
...
def verify() -> None:
    ...
    required = {
        ...
        "pip_back": 'enterBackPictureInPicture()' in player and 'trigger=BACK cleanUi=true' in player,
        "pip_clean_before_entry": 'applyPictureInPictureUi(true);' in player and 'postOnAnimation' in player,
        "pip_overlay_hidden": 'topOverlay.setVisibility(active ? View.GONE : View.VISIBLE);' in player,
